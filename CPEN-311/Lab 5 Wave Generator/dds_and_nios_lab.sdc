...
create_clock -period 37 [get_ports CLOCK_27]
...
create_clock -name freqgen_plots -period 1000 [get_registers {*Generate_Arbitrary_Divided_Clk32:Generate_Sampler_Clock|var_clk_div32:Div_Clk|tc_reg*}]
